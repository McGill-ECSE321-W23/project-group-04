...
public class StaffAccountController {
     ...
     * @param StaffAccountId - The unique ID of employee account
     ...
     * @param StaffAccountId - The unique ID of staff account whose schedule is being modified
     * @return - Either a message specifying the user is not authorized to perform this, or the schedule if the user is authorized to perform this
     * @author Edwin
     */
     ...
     * @param StaffAccountId - The unique ID of staff account to be fired
