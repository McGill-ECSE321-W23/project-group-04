...
export default {
    ...
    created() {
      ...
      // Initializing events
      this.AXIOS.get('/api/monthlyReservation/allReservations')
      .then(response => {
    ...
    methods: {
      createPerson: function (personName, phoneNumber) {
        this.AXIOS.post('/api/person/create?name='.concat(personName).concat('&phoneNumber=').concat(phoneNumber)
        , {}, {})
          .then(response => {
          // JSON responses are automatically parsed.
      ...
      findPersonByID: function (personID) {
        this.AXIOS.post('/api/person/get/'.concat(personID), {}, {})
          .then(response => {
          // JSON responses are automatically parsed.
      ...
      updatePerson: function (personID, newName, newPhone) {
        this.AXIOS.post('/api/person/update/'.concat(personID).concat('/name?').concat(newName).concat('&/phoneNumber?').concat(newPhone)
        , {}, {})
          .then(response => {
          // JSON responses are automatically parsed.
